<%@ Page Title="" Language="C#" MasterPageFile="~/harjoitustyo.master" AutoEventWireup="true" CodeFile="Gamez.aspx.cs" Inherits="Gamez" %>
<script runat="server">
    ...
    protected void btn_play_Click(object sender, EventArgs e)
    {
        ...
        lbl_roller3.Text = dice.getRoll3().ToString();
        bool d = dice.Triples();        
        bool d2 = dice.Doubles();
        ...
        {
            lbl_result.Text = dice.MessageClose();
            lbl_result.Visible = true;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <h2>
        Welcome to the Tales of Estelia Lotto! Try to get three of the same number for a special reward. Rewards include items, quests and monsters!
    </h2>
     ...
     <div style="height: 49px">
        ...
        style="margin-left: 11px" ></asp:Label>
          ...
          <asp:Label ID="lbl_roller3" runat="server" Text="0" BorderColor="Black" 
        BorderStyle="Solid" Height="40px" Width="17px" Font-Size="XX-Large" 
        style="margin-left: 11px" ></asp:Label>

        <asp:Button ID="btn_play_" runat="server" Height="26px" style="margin-top: 0px; margin-left: 127px;" 
            Text="Get Lucky!" onclick="btn_play_Click" />    
