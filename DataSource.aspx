...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server"><title>Databound Controls</title></asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <h1>ASP.NET Databound Controls</h1>
    <!-- DataSource määrittely -->
    <asp:SqlDataSource ID="srcMovies" ConnectionString="Data Source=eight.labranet.jamk.fi;Initial Catalog=Movie;Persist Security Info=True;User ID=koodari;Password=koodari13" SelectCommand="SELECT title, director, year FROM Movies ORDER BY title" runat="server"></asp:SqlDataSource>
    <!-- Kontrollit -->
    ...
    <asp:Repeater ID="Repeater1" DataSourceID="srcMovies" runat="server">
        <ItemTemplate>Movie <%#Eval("title") %> directed by <b><%#Eval("director") %></b> </ItemTemplate>
    </asp:Repeater>
    ...
    <asp:ListView ID="ListView1" DataSourceID="srcMovies" runat="server">
        ...
        <ItemTemplate>Movie <b><%#Eval("title") %> </b>directed by <%#Eval("director") %></br> </ItemTemplate>
    </asp:ListView>
</asp:Content>
